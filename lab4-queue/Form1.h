...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(92, 72);
			...
			this->start_button->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(204)));
			this->start_button->Location = System::Drawing::Point(41, 125);
...
#pragma endregion
	private: System::Void start_button_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 MaxSize = textBox1->Text;
				 TQueue<int> intque(MaxSize);
				 Size = textBox2->Text;
				 for ( int i = 0; i < Size; i++ )
					 intque.push(rand()%13);
				 int PofExt = textBox3->Text;
				 int PofAdd = textBox4->Text;

				 do{
					 if ( ){
						 gr->DrawArc(Pens::Black, xl, yl, xr, yr, su, sk);
						 gr->DrawArc(Pens::White, xl-, yl-, xr-, yr-, su, sk);
					 } else {
						 gr->DrawArc(Pens::White, xl, yl, xr, yr, su, sk);
					 }
				 } while ( );
